...
//PID参数 Balance_Kp=400,Balance_Kd=15.5,Velocity_Kp=77,Velocity_Ki=0.5,Turn_Kp=25,Turn_Kd=1;
...
int Pos_Pwm,Vel_Pwm;
//位置PID系数
float Position_KP=15.5,Position_KI=0.07,Position_KD=182; //d 215 	
//速度PID系数
...
//位置PID设定目标数
int Target_Position_L=800,Target_Position_R=0; 			
//速度PID设定目标数
