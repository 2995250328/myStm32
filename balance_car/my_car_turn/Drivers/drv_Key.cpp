...
extern float Turn_Target,Turn_Target_Tem;
extern int flag_360;
extern float Yaw;
	...
	if(tmp==1)
	{
		...
		else 
		{
			if(key_flag==0)
			{
				...
				Target_Position_L=1660,Target_Position_R=-1660;
				key_flag=1;
			}
			else if(key_flag==1)
			{
				Position_L=0,Position_R=0;
				Target_Position_L=1660*2,Target_Position_R=-1660*2;
				key_flag=2;
			}
			else if(key_flag==2)
			{
				Position_L=0,Position_R=0;
				Target_Position_L=1660*4,Target_Position_R=-1660*4;
				key_flag=3;
			}
			else if(key_flag==2)
			{
...
void EXTI0_IRQHandler(void)
{
	...
	if(KEY==0)       
	{
		...
		else 
		{
			...
			{
				if(Yaw+90<360)
					Turn_Target_Tem=Yaw+90;
				else if(Yaw+90>=360)
					Turn_Target_Tem=Yaw+90-360;
				key_flag=1;
			}
			else if(key_flag==1)
			{
				if(Yaw+180<360)
					Turn_Target_Tem=Yaw+180;
				else if(Yaw+180>=360)
					Turn_Target_Tem=Yaw+180-360;
				key_flag=2;
			}
			else if(key_flag==2)
			{
				flag_360=0;
				if(Yaw-5<0)
					Turn_Target_Tem=Yaw-5+360;
				else if(Yaw-5>=0)
					Turn_Target_Tem=Yaw-5;
				key_flag=3;
			}
			else if(key_flag==3)
			{
