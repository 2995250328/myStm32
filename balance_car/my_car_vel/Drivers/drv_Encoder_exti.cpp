...
void EXTI9_5_IRQHandler(void)    //编码器1的外部中断
{
	...
	else if (1 == GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_7)) //pc7上升沿
	{	
...
void EXTI15_10_IRQHandler(void)    //编码器2的外部中断
{
	...
	else if (1 == GPIO_ReadInputDataBit(GPIOD, GPIO_Pin_13)) //pc7上升沿
	{	
	...
	else if(0 == GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_13))//pc7下降沿
	{
