...
{
	u8 a[]={"LorR"};
	LCD_ShowIntNum(80,0,LorR,1,PURPLE,WHITE,32);
	LCD_ShowString(0,0,a,RED,WHITE,32,0);
	u8 b[]={"Num"};
	LCD_ShowIntNum(80,30,Num,1,PURPLE,WHITE,16);
	LCD_ShowString(0,33,b,RED,WHITE,16,0);
	u8 c[]={"FARFLAG"};
	LCD_ShowString(0,50,c,RED,WHITE,16,0);
	LCD_ShowIntNum(80,50,Far_Flag,1,PURPLE,WHITE,16);
	LCD_ShowChar(60,170,Target_Room,RED,WHITE,32,0);
	u8 d[]={"LOAD"};
	LCD_ShowString(0,80,d,RED,WHITE,16,0);
	LCD_ShowIntNum(40,80,Load_Flag,1,PURPLE,WHITE,16);
	u8 e[]={"open"};
	LCD_ShowString(0,100,e,RED,WHITE,16,0);
	LCD_ShowIntNum(40,100,OpenMv_Rx_Data[0],3,PURPLE,WHITE,16);
	u8 f[]={"blue"};
	LCD_ShowString(0,120,f,RED,WHITE,16,0);
	LCD_ShowIntNum(40,120,Car2,1,PURPLE,WHITE,16);
	u8 g[]={"mission"};
	LCD_ShowString(0,140,g,RED,WHITE,16,0);
	LCD_ShowIntNum(70,140,Mission,1,PURPLE,WHITE,16);
	LCD_ShowIntNum(0,210,Blooth_Uart_Rx_Buffer[7],2,PURPLE,WHITE,16);
}
