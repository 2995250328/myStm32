...
void Car_Spin(spin_dir_t Turn)
{
	...
	if(Turn==left_90)
	{
		Target_Position_L=-spin90_val*0.96;
		Target_Position_R=spin90_val*0.96;
	}
	...
	{
		Target_Position_L=-2*spin90_val*0.96;
		Target_Position_R=2*spin90_val*0.96;
	}
	else if(Turn==num_spin1)
	{
		Target_Position_L=-spin90_val*0.97*0.16;
		Target_Position_R=spin90_val*0.97*0.16;
	}
