...
USART_TypeDef*  SERIAL_USART[SERIALn] = {STARBOT_SERIAL1, STARBOT_SERIAL2, STARBOT_SERIAL3};
GPIO_TypeDef*   SERIAL_PORT[SERIALn] = {STARBOT_SERIAL1_GPIO_PORT, STARBOT_SERIAL2_GPIO_PORT, STARBOT_SERIAL3_GPIO_PORT}; 
const uint32_t  SERIAL_USART_CLK[SERIALn] = {STARBOT_SERIAL1_CLK, STARBOT_SERIAL2_CLK, STARBOT_SERIAL3_CLK};
const uint32_t  SERIAL_PORT_CLK[SERIALn] = {STARBOT_SERIAL1_GPIO_CLK, STARBOT_SERIAL2_GPIO_CLK, STARBOT_SERIAL3_GPIO_CLK};
const uint16_t  SERIAL_TX_PIN[SERIALn] = {STARBOT_SERIAL1_TX_PIN, STARBOT_SERIAL2_TX_PIN, STARBOT_SERIAL3_TX_PIN}; 
const uint16_t  SERIAL_RX_PIN[SERIALn] = {STARBOT_SERIAL1_RX_PIN, STARBOT_SERIAL2_RX_PIN, STARBOT_SERIAL2_RX_PIN}; 
const uint16_t  SERIAL_IRQn[SERIALn] = {STARBOT_SERIAL1_IRQ, STARBOT_SERIAL2_IRQ, STARBOT_SERIAL3_IRQ};
const uint16_t  SERILA_NVIC[SERIALn] = {STARBOT_SERIAL1_NVIC, STARBOT_SERIAL2_NVIC, STARBOT_SERIAL3_NVIC};
